        ...
        <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <header className="space-y-4">
                ...
                <h1 className="text-4xl font-black text-slate-800 uppercase tracking-tighter">
                    Что нужно для <span className="text-primary">работы</span>
                </h1>
            ...
            <section className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <FormatCard title=".XLSX" desc="Стандартный формат современного Excel" />
                    <FormatCard title=".XLS" desc="Старый формат Excel (97-2003)" />
                    <FormatCard title=".CSV" desc="Текстовые таблицы из других программ" />
                </div>
            </section>
                    ...
                    <CardBody className="p-6 flex flex-row gap-5 items-start">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-xs text-slate-600 leading-relaxed">
                                Это самая важная часть: когда вы загружаете файл, он <b>не отправляется в интернет</b>. 
