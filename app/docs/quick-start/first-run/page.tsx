        ...
        <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <header className="space-y-4">
                ...
                <h1 className="text-4xl font-black text-slate-800 uppercase tracking-tighter">
                    Ваша первая <span className="text-primary">выгрузка</span>
                </h1>
            ...
            <section className="space-y-6">
                ...
                <p className="text-slate-600 text-sm leading-relaxed">
                    ...
                    Для начала попробуйте добавить <b>«Проекцию колонок»</b> — это самый важный шаг, где вы выбираете, какие столбцы оставить в финальном отчете.
                </p>
            ...
            <section className="space-y-6">
                ...
                <p className="text-slate-600 text-sm leading-relaxed">
                    Когда все шаги добавлены и настроены, нажмите яркую синюю кнопку <b>«Запустить сбор»</b> в верхнем правом углу экрана. 
            ...
            <section className="space-y-4 p-6 bg-primary-50 rounded-2xl border border-primary-100">
                ...
                <p className="text-xs text-slate-600 leading-relaxed">
                    Вы только что создали свою первую автоматическую выгрузку. Теперь вы можете сохранить этот набор действий как <b>Шаблон</b>, 
