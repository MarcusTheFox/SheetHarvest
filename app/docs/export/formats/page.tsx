        ...
        <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <header className="space-y-4">
                ...
                <h1 className="text-4xl font-black text-slate-800 uppercase tracking-tighter">
                    Форматы <span className="text-primary">Экспорта</span>
                </h1>
            ...
            <section className="space-y-6">
                ...
                <p className="text-slate-600 text-sm leading-relaxed">
                    ...
                    Это важно, так как <b>введенное имя станет названием файла</b> или названием листа в Excel.
                </p>
                    ...
                    <CardBody className="p-6 flex flex-row gap-5 items-center text-white">
                        ...
                        <div className="space-y-1">
                            ...
                            <p className="text-xs text-primary-50 leading-relaxed">
                                Кнопка <b>«Экспортировать всё (XLSX)»</b> соберет все ваши таблицы в один Excel-файл. 
