        ...
        <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <header className="space-y-4">
                ...
                <h1 className="text-4xl font-black text-slate-800 uppercase tracking-tighter">
                    Работа с <span className="text-primary">Шаблонами</span>
                </h1>
                ...
                <div className="space-y-4">
                    <div className="flex gap-4 items-start">
                        ...
                        <p className="text-xs text-slate-600 leading-relaxed">
                            Найдите поле <b>«Название шаблона»</b> в левой или правой нижней части экрана.
                        </p>
                    </div>
                    <div className="flex gap-4 items-start">
                        <div className="w-6 h-6 rounded-full bg-slate-100 flex items-center justify-center text-[10px] font-bold shrink-0 mt-1">2</div>
                        <p className="text-xs text-slate-600 leading-relaxed">
                            Введите понятное имя (например, <i>«Прайс Техника — Поставщик А»</i>) и нажмите на иконку <b>дискеты (Сохранить)</b>.
                        </p>
                    </div>
                </div>
            </section>
                    ...
                    <CardBody className="p-6 flex flex-col md:flex-row gap-6 items-center">
                        <div className="flex-1 space-y-2 text-center md:text-left">
                            ...
                            <p className="text-xs text-slate-500 leading-relaxed">
                                Все ваши сохраненные инструкции находятся в блоке <b>«Сохраненные шаблоны»</b>. 
                ...
                <CardBody className="p-6 flex flex-row gap-5 items-start text-white">
                    ...
                    <div className="space-y-1">
                        ...
                        <p className="text-xs text-slate-400 leading-relaxed italic">
                            «Идеальный рабочий процесс в SheetHarvest выглядит так: <br />
                            1. Загрузили новый файл. <br />
                            2. Кликнули на имя шаблона. <br />
                            3. Нажали „Запустить сбор“. <br />
