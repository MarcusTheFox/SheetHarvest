        ...
        <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <header className="space-y-4">
                ...
                <p className="text-lg text-slate-500 leading-relaxed">
                    ...
                    что такое <b>Пайплайн</b> и как работают <b>Слои</b>.
                </p>
            </header>
            ...
            <section className="space-y-6">
                ...
                <p className="text-slate-600 text-sm leading-relaxed">
                    Каждое действие, которое вы добавляете — это <b>Слой</b>. 
                    ...
                    <Card className="border-dashed border-2 border-slate-200 bg-white shadow-none flex items-center justify-center p-6 text-center" radius="lg">
                        <div className="space-y-2">
                            ...
                            <p className="text-[11px] text-slate-500 leading-normal">
                                На каждом шаге вы видите две таблицы: <br />
                                <b>«До»</b> (как данные пришли на шаг) <br />
                                и <b>«После»</b> (что с ними сделал этот инструмент).
                            </p>
                        </div>
                    </Card>
                </div>
