        ...
        <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <header className="space-y-4">
                ...
                <h1 className="text-4xl font-black text-slate-800 uppercase tracking-tighter">
                    Сопоставление <span className="text-primary">значений</span>
                </h1>
                <p className="text-lg text-slate-500 leading-relaxed">
                    Часто в прайсах один и тот же бренд написан по-разному: <i>«Sams.»</i>, <i>«SAMS»</i> или <i>«Samsung»</i>. 
            ...
            <section className="space-y-6">
                ...
                <p className="text-slate-600 text-sm leading-relaxed">
                    Это <b>самое важное</b> преимущество: ваши исправления сохраняются не только для текущего файла, 
                        ...
                        <CardBody className="p-5 flex gap-4">
                            ...
                            <div className="space-y-1">
                                ...
                                <p className="text-[11px] text-slate-500 leading-normal">
                                    Если завтра вы загрузите другой файл от другого поставщика, и там снова будет <i>«App.»</i>, 
                                    программа сама заменит его на <i>«Apple»</i>. Вам не нужно делать это снова.
                                </p>
                            </div>
                        </CardBody>
                    </Card>
