        ...
        <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <header className="space-y-4">
                ...
                <h1 className="text-4xl font-black text-slate-800 uppercase tracking-tighter">
                    Разделение <span className="text-primary">Матрицы</span>
                </h1>
                <p className="text-lg text-slate-500 leading-relaxed">
                    Этот инструмент превращает одну большую таблицу в <b>целую стопку отдельных таблиц</b>. 
            ...
            <section className="space-y-6">
                ...
                <p className="text-slate-600 text-sm leading-relaxed">
                    ...
                    {" "}
                    <b>«Остаток Москва»</b>, <b>«Остаток Питер»</b> и <b>«Остаток Казань»</b>. <br /><br />
                    Инструмент «Матрица» возьмет этот файл и создаст из него <b>три разные таблицы</b>. 
                    Названия колонок (Москва, Питер, Казань) станут <b>названиями этих таблиц</b>.
                </p>
                        ...
                        <CardBody className="p-4 flex gap-4 items-start">
                            ...
                            <div className="space-y-1">
                                ...
                                <p className="text-[11px] text-slate-500 leading-normal">
                                    Выберите колонки, которые должны быть в <b>каждой</b> из новых таблиц (например: Артикул и Название товара).
                                </p>
                            </div>
                        </CardBody>
                    </Card>
                    ...
                    <Card className="border border-slate-100 shadow-none bg-slate-50/50" radius="sm">
                        <CardBody className="p-4 flex gap-4 items-start">
                            ...
                            <div className="space-y-1">
                                ...
                                <p className="text-[11px] text-slate-500 leading-normal">
                                    Выберите колонки, названия которых станут <b>именами новых таблиц</b>. 
                ...
                <CardBody className="p-6 flex flex-row gap-5 items-start">
                    ...
                    <div className="space-y-1">
                        ...
                        <p className="text-xs text-slate-400 leading-relaxed">
                            ...
                            Каждую из них можно просмотреть отдельно, а при экспорте в Excel они превратятся в <b>отдельные листы</b> одного файла.
                        </p>
                    </div>
                </CardBody>
            </Card>
