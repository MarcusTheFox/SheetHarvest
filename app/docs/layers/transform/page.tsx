        ...
        <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <header className="space-y-4">
                ...
                <h1 className="text-4xl font-black text-slate-800 uppercase tracking-tighter">
                    Трансформация <span className="text-primary">Колонок</span>
                </h1>
            ...
            <section className="space-y-6">
                ...
                <div className="p-4 bg-slate-50 border border-slate-100 rounded-xl space-y-3">
                    ...
                    <p className="text-xs text-slate-600">
                        В ячейке написано: <i>«В наличии 50 шт, цена за ед. 1500р»</i>. <br />
                        С помощью шаблона <b>\d+</b> программа вытянет из этой строки только число <b>50</b>.
                    </p>
                </div>
            </section>
            ...
            <section className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <MiniAction icon={<Plus size={14} />} title="Добавить колонку" desc="Создает новую колонку с одинаковым текстом во всех строках." />
                    <MiniAction icon={<Trash2 size={14} />} title="Удалить колонку" desc="Просто выбрасывает ненужные столбцы из таблицы." />
                    <MiniAction icon={<Type size={14} />} title="Переименовать" desc="Быстрое изменение заголовка любой колонки." />
                    <MiniAction icon={<Columns size={14} />} title="Порядок" desc="Перетаскивание колонок влево или вправо." />
                </div>
            </section>
