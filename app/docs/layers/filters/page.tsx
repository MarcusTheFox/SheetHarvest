        ...
        <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <header className="space-y-4">
                ...
                <h1 className="text-4xl font-black text-slate-800 uppercase tracking-tighter">
                    Фильтрация и
                    { " " }
                    <span className="text-primary">Очистка</span>
                </h1>
            ...
            <section className="space-y-6">
                ...
                <p className="text-slate-600 text-sm leading-relaxed">
                    Этот инструмент проверяет «скелет» строки. Вы указываете программе, какие колонки
                    { " " }
                    <b>обязательно</b>
                    { " " }
                    должны быть заполнены, а какие —
                    { " " }
                    <b>обязательно</b>
                    { " " }
                    пустыми.
                ...
                <Card className="border border-slate-200 shadow-none bg-slate-50/50" radius="lg">
                    <CardBody className="p-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div className="flex items-center gap-3">
                                <div className="w-8 h-8 rounded bg-slate-200 flex items-center justify-center text-slate-600">
                                    <Minus size={ 14 } />
                                </div>
                            ...
                            <div className="flex items-center gap-3">
                                <div className="w-8 h-8 rounded bg-success text-white flex items-center justify-center shadow-md shadow-success/20">
                            ...
                            <div className="flex items-center gap-3">
                                <div className="w-8 h-8 rounded bg-danger text-white flex items-center justify-center shadow-md shadow-danger/20">
                ...
                <div className="p-4 bg-slate-50 border border-slate-100 rounded-xl flex gap-4 items-start">
                    ...
                    <p className="text-xs text-slate-500 leading-relaxed italic">
                        <b>Пример:</b>
                        { " " }
                        Если вы поставите «Заполнено» для колонки «Артикул», программа удалит все строки, где артикул не указан (включая пустые строки между категориями товаров).
                    </p>
                </div>
            </section>
            ...
            <section className="space-y-6">
                ...
                <p className="text-slate-600 text-sm leading-relaxed">
                    Если «Топология» смотрит только на наличие данных, то этот инструмент проверяет
                    { " " }
                    <b>содержимое</b>
                    { " " }
                    ячеек. Он работает как строгий контролер на входе.
                </p>
                ...
                <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <RuleItem desc="Удалит строку, если в колонке «Цена» внезапно встретится текст «звоните» или «цена по запросу»." title="Только Число" />
                        <RuleItem desc="Гарантирует, что важная информация (например, Название) присутствует в строке." title="Не пустое" />
                        <RuleItem desc="Проверит, что в ячейке указана корректная дата, а не случайный набор символов." title="Дата" />
                        <RuleItem desc="Сложная проверка для тех, кто знает регулярные выражения (например, проверка формата E-mail)." title="Regex (Шаблон)" />
                    </div>
                </div>
            </section>
