        ...
        <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <header className="space-y-4">
                ...
                <h1 className="text-4xl font-black text-slate-800 uppercase tracking-tighter">
                    Навигация и <span className="text-primary">Поиск</span>
                </h1>
            ...
            <section className="space-y-6">
                ...
                <p className="text-slate-600 text-sm leading-relaxed">
                    Этот инструмент работает как <b>ножницы</b>. Вы указываете программе: «Начни собирать данные, когда встретишь текст Х, и закончи, когда увидишь текст Y». 
                </p>
                ...
                <div className="p-4 bg-blue-50 border border-blue-100 rounded-xl space-y-2">
                    ...
                    <ul className="list-none space-y-1">
                        <li className="text-[11px] text-blue-600 italic"><b>• Включить маркер:</b> Если галочка стоит, строка с самим словом-якорем тоже попадет в результат.</li>
                        <li className="text-[11px] text-blue-600 italic"><b>• Склеить результаты:</b> Если в файле несколько таблиц, этот переключатель соберет их в один список.</li>
                    </ul>
                </div>
            </section>
                ...
                <div className="flex flex-col md:flex-row gap-6 items-center bg-slate-50 p-6 rounded-2xl border border-slate-100">
                    <div className="space-y-2 flex-1">
                        ...
                        <p className="text-xs text-slate-500 leading-relaxed">
                            ...
                            просто введите число <b>3</b> в настройках. Программа будет «откусывать» их автоматически.
                        </p>
                    </div>
                ...
                <CardBody className="p-6 flex flex-row gap-5 items-start">
                    ...
                    <div className="space-y-1">
                        ...
                        <p className="text-xs text-slate-400 leading-relaxed">
                            Если положение таблицы в файле всегда меняется — используйте <b>«Якоря»</b> (они ищут текст). 
                            Если таблица всегда начинается с одной и той же строки — используйте <b>«Пропуск строк»</b> (это быстрее).
                        </p>
                    </div>
                </CardBody>
            </Card>
