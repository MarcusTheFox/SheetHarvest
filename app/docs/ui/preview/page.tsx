        ...
        <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <header className="space-y-4">
                ...
                <h1 className="text-4xl font-black text-slate-800 uppercase tracking-tighter">
                    Окно <span className="text-primary">Просмотра</span>
                </h1>
                    ...
                    <Card className="border border-slate-200 shadow-none bg-slate-50/30" radius="sm">
                        <CardBody className="p-5 space-y-2">
                            ...
                            <p className="text-xs text-slate-500 leading-normal">
                                Показывает состояние таблицы <b>до</b> того, как текущий инструмент её коснулся. Это то, что передал предыдущий шаг.
                            </p>
                        </CardBody>
                    </Card>
                ...
                <CardBody className="p-6 flex flex-row gap-5 items-start">
                    ...
                    <div className="space-y-1">
                        ...
                        <p className="text-xs text-slate-600 leading-relaxed">
                            Вы можете менять высоту областей «До» и «После». Просто зажмите мышкой <b>разделительную линию</b> между таблицами и потяните её вверх или вниз.
                        </p>
                    </div>
                </CardBody>
            </Card>
