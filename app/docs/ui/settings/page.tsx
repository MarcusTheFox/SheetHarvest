        ...
        <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <header className="space-y-4">
                ...
                <h1 className="text-4xl font-black text-slate-800 uppercase tracking-tighter">
                    Панель <span className="text-primary">Настроек</span>
                </h1>
                        ...
                        <CardBody className="p-4 flex gap-4 items-start">
                            ...
                            <div className="space-y-1">
                                ...
                                <p className="text-[11px] text-slate-500 leading-normal">
                                    ...
                                    Все изменения <b>применяются мгновенно</b> к нижней таблице предпросмотра.
                                </p>
                            </div>
                        </CardBody>
                    </Card>
            ...
            <section className="space-y-4">
                ...
                <p className="text-slate-600 text-sm leading-relaxed">
                    ...
                    с помощью клавиши <b>Tab</b>. Все списки выбора поддерживают поиск — просто начните печатать название колонки.
                </p>
            </section>
